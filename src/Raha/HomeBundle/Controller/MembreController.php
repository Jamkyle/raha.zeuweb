...
use Raha\HomeBundle\Entity\Membre;
use Raha\HomeBundle\Form\MembreType;
...
class MembreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RahaHomeBundle:Membre')->findAll();
     ...
     * @Method("POST")
     * @Template("RahaHomeBundle:Membre:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RahaHomeBundle:Membre')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RahaHomeBundle:Membre:edit.html.twig")
     */
